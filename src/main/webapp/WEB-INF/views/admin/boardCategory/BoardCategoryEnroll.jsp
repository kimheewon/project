	                    ...
	                    <div class="col-md-12 col-sm-12 col-xs-12">
		                   <div class="x_panel">
			                   ...
			                   <div class="x_content"><br/>
				                   <form id="enrollInfo" name="enrollInfo" data-parsley-validate class="form-horizontal form-label-left" action="/BoardCategory/BoardCategoryEnroll" method="POST">
	    ...
	    $(document).ready(function () {
	        ...
	        $("#boardNameCheck").on("click",function(){
	            ...
	            if(document.getElementById("boardName").value==""){
	             ...
	             $.ajax({   
	                type:"POST",
	                url:"/BoardCategory/BoardCategoryNameCheck",   
