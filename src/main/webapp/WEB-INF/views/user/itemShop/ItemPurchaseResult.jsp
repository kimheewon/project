    ...
    <h3 style="color:#2c3e50;margin-left: 6%;"></h3><br><br><br>
        <form action="/ItemShop/" method="post">
            ...
            <table id="deliverTable">
                ...
                <tr>
                   <td style="padding-left: 2%;border-right: 1px solid #aeaea7;border-bottom: 1px solid #aeaea7;font-size: 12pt;height: 50px;">주문번호</td>
                ...
                <tr>
                   ...
                   <td style="padding-left: 2%;height: 40px;border-bottom: 1px solid #aeaea7;">(${deliver.strPostcode})&nbsp;${deliver.strAddress}&nbsp;${deliver.strAddress2}</td>
               </tr>
               <tr>
